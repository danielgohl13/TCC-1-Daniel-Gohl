...
No Brasil há uma grande diversidade de redes fluviais, muitas dessas redes fluviais tendem a ter águas brancas, que possuem alta turbidez dificultando a visibilidade, locomoção e exploração dentro da água, comprometendo o desempenho de profissionais e pesquisadores. Este trabalho propõe o projeto e avaliação de um sistema computacional móvel que seja capaz de detectar objetos submersos em ambientes aquáticos com baixa visibilidade, e que possa calcular a estimativa da distância e as dimensões de objetos baseado em processamento de imagens, 
...
% de sistema computacional que adota uma boia com suporte remoto que será capaz de coletar imagens e classificá-las, mostrando resultados para o usuário. 
% A construção da boia visa utilizar materiais de baixo custo e de fácil acesso como canos de PVC. 
O projeto irá utilizar modelos formais para validação da execução e previsibilidade do sistema computacional proposto.


 \vspace{\onelineskip}
 
 \noindent 
 \textbf{Palavras-chaves}: Sistemas Computacionais; Sensores; Classificação de Imagens.
\end{resumo}
