...
\renewcommand{\dataDefesa}{30/01/18}
\renewcommand{\orientadorBanca}{Herbert Oliveira Rocha, D,Sc.}
\renewcommand{\primeiroMembroBanca}{Leandro Nelinho Balico, D.Sc.}
\renewcommand{\segundoMembroBanca}{Felipe Leite Lobo, M,Sc.}
...
\begin{dedicatoria}
   ...
   \noindent
   \textit{ } \vspace*{\fill}
   Dedico esse trabalho a minha mãe, minha namorada, família e amigos.
...
Primeiramente minha mãe, que sempre fez tudo por mim e pelos meus irmãos, valeu mãe, e também a minha família, nisso incluo meu pai, tio, irmãos e a família da minha ex-namorada e grande amiga, Eduarda, que me adotou.

\centering \textit{Vereor Nox}
