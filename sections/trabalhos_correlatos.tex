...
No método proposto por \citeonline{FORESTI2000AImages} são aplicados alguns filtros\todo{Descrever quais?} para compensação de cor e dimensionamento na imagem. Depois do dimensionamento essas imagens ganham tamanhos de $1/16$ para detecção de bordas (para encontrar canos) e $1/32$ para encontrar anodos em canos.
\begin{figure}[h]
...
A \autoref{fig:bazeillemetod}, mostra o resultado da aplicação de diversas técnicas\todo{Exemplificar} para processamento de imagem e remoção de pertubações, como atenuações de luz.
% 
