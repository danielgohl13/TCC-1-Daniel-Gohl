...
Máquina finita de estados é um automato que ajuda a demonstrar o fluxo de um sistema computacional. (pré-texto) 
...
\section{Frameworkds para identificação de imagem}
