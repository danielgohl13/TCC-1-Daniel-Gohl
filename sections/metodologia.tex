...
Corpo da boia, feito de materiais de fácil acesso, como canos de PVC, ou estruturas plásticas. 

Sensor de captura optíca (câmera) que estará atrelado a parte inferior da boia.

Antena externa atrelada a plataformaa de sistema integrada (Single Board Computer)

Placa solar que alimentará parte do sistema 
